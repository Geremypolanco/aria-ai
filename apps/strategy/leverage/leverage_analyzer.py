...
class LeverageAnalyzer:
    ...
    async def constraint_removal_plan(self, bottleneck: str) -> list[dict]:
        ...
        plans: dict[str, list[dict]] = {
            "conversion": [
                {
                    "step": 1,
                    "action": "Audit current funnel with heatmaps and session recordings",
                    "expected_outcome": "Identify top 3 drop-off points",
                    "timeframe_days": 3,
                },
                {
                    "step": 2,
                    "action": "Fix top friction point (form length, load speed, or clarity)",
                    "expected_outcome": "5-15% CVR improvement at that stage",
                    "timeframe_days": 7,
                },
                {
                    "step": 3,
                    "action": "A/B test new headline and primary CTA",
                    "expected_outcome": "Identify winning variant with 95% confidence",
                    "timeframe_days": 14,
                },
                {
                    "step": 4,
                    "action": "Add social proof section (reviews, logos, stats)",
                    "expected_outcome": "Build trust, reduce bounce rate by 10-20%",
                    "timeframe_days": 5,
                },
                {
                    "step": 5,
                    "action": "Implement exit-intent offer",
                    "expected_outcome": "Recover 5-10% of abandoning visitors",
                    "timeframe_days": 3,
                },
            ],
            "retention": [
                {
                    "step": 1,
                    "action": "Survey churned customers to identify top 3 exit reasons",
                    "expected_outcome": "Actionable retention insights",
                    "timeframe_days": 7,
                },
                {
                    "step": 2,
                    "action": "Fix #1 churn reason (product gap, pricing, or UX)",
                    "expected_outcome": "Reduce churn by 20-30%",
                    "timeframe_days": 21,
                },
                {
                    "step": 3,
                    "action": "Launch 30-day onboarding email sequence",
                    "expected_outcome": "Improve activation rate by 15%",
                    "timeframe_days": 10,
                },
                {
                    "step": 4,
                    "action": "Add in-app milestone celebrations and progress tracking",
                    "expected_outcome": "Increase daily active usage by 10%",
                    "timeframe_days": 14,
                },
            ],
            "traffic": [
                {
                    "step": 1,
                    "action": "Keyword research — find 20 buying-intent keywords with low competition",
                    "expected_outcome": "Content roadmap for organic growth",
                    "timeframe_days": 5,
                },
                {
                    "step": 2,
                    "action": "Publish 4 cornerstone SEO articles targeting priority keywords",
                    "expected_outcome": "Begin ranking in 60-90 days",
                    "timeframe_days": 30,
                },
                {
                    "step": 3,
                    "action": "Launch paid acquisition test on top 1 channel ($500 budget)",
                    "expected_outcome": "Establish CPL/CPA benchmark",
                    "timeframe_days": 14,
                },
                {
                    "step": 4,
                    "action": "Set up referral program for customer-led growth",
                    "expected_outcome": "5-10% of new customers from referrals",
                    "timeframe_days": 10,
                },
            ],
            "revenue": [
                {
                    "step": 1,
                    "action": "Analyze purchase data to find natural upsell moments",
                    "expected_outcome": "Identify 2-3 upsell opportunities",
                    "timeframe_days": 3,
                },
                {
                    "step": 2,
                    "action": "Create complementary product bundle at 15% discount",
                    "expected_outcome": "Increase AOV by 25-40%",
                    "timeframe_days": 7,
                },
                {
                    "step": 3,
                    "action": "Add post-purchase 1-click upsell",
                    "expected_outcome": "10-15% upsell take rate",
                    "timeframe_days": 5,
                },
                {
                    "step": 4,
                    "action": "Launch premium tier with expanded value",
                    "expected_outcome": "20% of customers upgrade",
                    "timeframe_days": 21,
                },
            ],
        }
        ...
        if not plan:
            plan = [
                {
                    "step": 1,
                    "action": f"Audit current state of '{bottleneck}'",
                    "expected_outcome": "Baseline measurement established",
                    "timeframe_days": 5,
                },
                {
                    "step": 2,
                    "action": f"Identify root cause of underperformance in '{bottleneck}'",
                    "expected_outcome": "Prioritized fix list",
                    "timeframe_days": 7,
                },
                {
                    "step": 3,
                    "action": "Implement top fix and measure impact",
    ...
    async def simulate_improvement(self, metrics: dict, lever: str, improvement_pct: float) -> dict:
...
_analyzer_instance: LeverageAnalyzer | None = None
