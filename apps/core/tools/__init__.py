...
from apps.core.tools.google_tools import GoogleTools          # original
from apps.core.tools.google_suite import GoogleSuite          # NUEVO — suite completa
from apps.core.tools.huggingface_suite import HuggingFaceSuite  # NUEVO — suite completa
