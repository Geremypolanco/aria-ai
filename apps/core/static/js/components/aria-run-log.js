...
const ARIA_MISSIONS = [
  ...
  {
    goal: 'Turn our latest blog into a LinkedIn post',
    title: 'LinkedIn post · from blog',
    steps: [
      'Read the post + top comments',
      'Drafted 3 hook variants',
      'Picked the strongest & wrote it',
      'Scheduled to LinkedIn',
    ],
    file: 'linkedin-post.txt',
    meta: '1,180 chars · ready to publish',
    time: '41s',
  },
  {
    goal: 'Create a hero image for the new feature',
    title: 'Hero image · new feature',
    steps: [
      'Pulled brand palette + references',
      'Generated 4 concepts',
      'Upscaled the winner to 4K',
      'Exported PNG + web sizes',
    ],
    file: 'hero-image.png',
    meta: '2400×1350 · PNG · ready',
    time: '58s',
  },
];
