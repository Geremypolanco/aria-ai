...
class SquareEngine:
    def __init__(self, access_token: str | None = None, environment: str = "sandbox"):
                    ...
                    "variations": [
                        {
                            ...
                            "item_variation_data": {
                                ...
                                "price_money": {"amount": price_money, "currency": currency},
                            },
                        }
                    ],
                },
    ...
    async def create_payment_link(
                ...
                "line_items": [
                    {
                        "name": name,
                        "quantity": "1",
                        "base_price_money": {"amount": price_money, "currency": currency},
                    }
                ],
            },
        }
        ...
        async with httpx.AsyncClient() as client:
            ...
            if res.status_code in (200, 201):
                return {
                    "success": True,
                    "payment_link": res.json().get("payment_link", {}).get("url"),
                }
            return {"success": False, "error": res.text}
