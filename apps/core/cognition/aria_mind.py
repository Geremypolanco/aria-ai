...
- check_objectives → muestra el estado de los 25 objetivos estratégicos autónomos de ARIA (growth loops, shopify, content, market intelligence, CRM, rebalanceo, morning briefing, product_launch_blitz, daily_revenue_digest, bundle_and_waitlist, challenge_day_sequencer, partner_outreach_cycle, proactive_analysis, social_organic, strategy_optimizer, self_improve, youtube_cycle, product_hunt_cycle, trend_detector, weekly_review, content_calendar_builder, competitor_intel, auto_social_publisher, revenue_aggregator, email_funnel_handler). Args: {{}}
- run_objective    → ejecuta un objetivo estratégico específico ahora mismo. Args: {{"objective": "growth_loops_cycle|shopify_optimization|content_generation|market_intelligence|crm_nurture|economic_rebalancing|morning_briefing|product_launch_blitz|daily_revenue_digest|bundle_and_waitlist|challenge_day_sequencer|partner_outreach_cycle|proactive_analysis|social_organic|strategy_optimizer|self_improve|youtube_cycle|product_hunt_cycle|trend_detector|weekly_review|content_calendar_builder|competitor_intel|auto_social_publisher|revenue_aggregator|email_funnel_handler"}}
