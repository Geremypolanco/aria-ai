...
class ConnectionManager:
    ...
    NO_OAUTH = {"indeed", "discord", "airtable", "quickbooks", "calcom",
                "mixpanel", "amplitude", "datadog", "klaviyo", "activecampaign",
                "convertkit", "brevo", "postmark", "netlify", "cloudflare",
                "firebase", "aws_s3", "wordpress", "webflow", "contentful", "sanity",
                "woocommerce", "amazon", "notion"}
